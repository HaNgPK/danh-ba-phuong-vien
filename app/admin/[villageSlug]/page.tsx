...
export default async function AdminPage({
  ...
  try {
    ...
    contacts = await prisma.contact.findMany({ where: { villageId: village.id }, orderBy: { createdAt: 'desc' } });
  ...
  return <AdminPanel village={village} initialContacts={contacts} initialScopes={scopes} initialButtons={buttons} />;
}
